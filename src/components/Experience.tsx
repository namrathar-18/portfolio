...
const experiences = [
  ...
  },
  {
    ...
    description: 'Completed AI live projects through Artifintel in association with Skill Vertex. Worked on real-world Artificial Intelligence projects, demonstrating diligence, consistency, and determination. Certificate ID: RA226798.',
    icon: Cpu,
    color: 'neon-green',
    badge: 'INTERNSHIP',
  },
